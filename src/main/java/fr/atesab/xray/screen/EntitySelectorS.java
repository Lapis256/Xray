...
public abstract class EntitySelectorS extends XrayScreen {
    ...
    public EntitySelectorS(Screen parent) {
...
//        XrayEntityMenu.EntityUnion hovered = null;
        int i;
...
//            int y = top + (i / elementsX) * 18;
            ...
            if (/*hovered == null &&*/ mouseX >= x && mouseX <= x + 200 && mouseY >= y && mouseY <= y + 20) {
                color = 0x33ffffff;
//                hovered = b;
            } else {
                color = 0x22ffffff;
...
//        if (hovered != null) {
//            graphics.renderTooltip(font, hovered.getTitle(), mouseX, mouseY);
//        }
    }
...
//        int left = width / 2 - elementsX * 20 / 2;
        int left = width / 2 - 200 / 2;
        int top = height / 2 - elementsY * 20 / 2;
